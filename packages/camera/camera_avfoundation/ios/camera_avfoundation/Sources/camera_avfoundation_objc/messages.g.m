...
@interface FCPPlatformCameraExposureDescription ()
+ (FCPPlatformCameraExposureDescription *)fromList:(NSArray<id> *)list;
+ (nullable FCPPlatformCameraExposureDescription *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface FCPPlatformExposureStateValue ()
+ (FCPPlatformExposureStateValue *)fromList:(NSArray<id> *)list;
+ (nullable FCPPlatformExposureStateValue *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FCPPlatformCameraExposureDescription
+ (instancetype)makeWithCurrentExpoMode:(FCPPlatformExposureMode)currentExpoMode
    currentExpoOffset:(double )currentExpoOffset
    minExpoOffset:(double )minExpoOffset
    maxExpoOffset:(double )maxExpoOffset
    currentExpoISO:(double )currentExpoISO
    minExpoISO:(double )minExpoISO
    maxExpoISO:(double )maxExpoISO
    currentExpoTimeNs:(NSInteger )currentExpoTimeNs
    minExpoTimeNs:(NSInteger )minExpoTimeNs
    maxExpoTimeNs:(NSInteger )maxExpoTimeNs {
  FCPPlatformCameraExposureDescription* pigeonResult = [[FCPPlatformCameraExposureDescription alloc] init];
  pigeonResult.currentExpoMode = currentExpoMode;
  pigeonResult.currentExpoOffset = currentExpoOffset;
  pigeonResult.minExpoOffset = minExpoOffset;
  pigeonResult.maxExpoOffset = maxExpoOffset;
  pigeonResult.currentExpoISO = currentExpoISO;
  pigeonResult.minExpoISO = minExpoISO;
  pigeonResult.maxExpoISO = maxExpoISO;
  pigeonResult.currentExpoTimeNs = currentExpoTimeNs;
  pigeonResult.minExpoTimeNs = minExpoTimeNs;
  pigeonResult.maxExpoTimeNs = maxExpoTimeNs;
  return pigeonResult;
}
+ (FCPPlatformCameraExposureDescription *)fromList:(NSArray<id> *)list {
  FCPPlatformCameraExposureDescription *pigeonResult = [[FCPPlatformCameraExposureDescription alloc] init];
  FCPPlatformExposureModeBox *boxedFCPPlatformExposureMode = GetNullableObjectAtIndex(list, 0);
  pigeonResult.currentExpoMode = boxedFCPPlatformExposureMode.value;
  pigeonResult.currentExpoOffset = [GetNullableObjectAtIndex(list, 1) doubleValue];
  pigeonResult.minExpoOffset = [GetNullableObjectAtIndex(list, 2) doubleValue];
  pigeonResult.maxExpoOffset = [GetNullableObjectAtIndex(list, 3) doubleValue];
  pigeonResult.currentExpoISO = [GetNullableObjectAtIndex(list, 4) doubleValue];
  pigeonResult.minExpoISO = [GetNullableObjectAtIndex(list, 5) doubleValue];
  pigeonResult.maxExpoISO = [GetNullableObjectAtIndex(list, 6) doubleValue];
  pigeonResult.currentExpoTimeNs = [GetNullableObjectAtIndex(list, 7) integerValue];
  pigeonResult.minExpoTimeNs = [GetNullableObjectAtIndex(list, 8) integerValue];
  pigeonResult.maxExpoTimeNs = [GetNullableObjectAtIndex(list, 9) integerValue];
  return pigeonResult;
}
+ (nullable FCPPlatformCameraExposureDescription *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformCameraExposureDescription fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    [[FCPPlatformExposureModeBox alloc] initWithValue:self.currentExpoMode],
    @(self.currentExpoOffset),
    @(self.minExpoOffset),
    @(self.maxExpoOffset),
    @(self.currentExpoISO),
    @(self.minExpoISO),
    @(self.maxExpoISO),
    @(self.currentExpoTimeNs),
    @(self.minExpoTimeNs),
    @(self.maxExpoTimeNs),
  ];
}
...
@implementation FCPPlatformExposureStateValue
+ (instancetype)makeWithExpoTimeNs:(NSInteger )expoTimeNs
    expoISO:(double )expoISO {
  FCPPlatformExposureStateValue* pigeonResult = [[FCPPlatformExposureStateValue alloc] init];
  pigeonResult.expoTimeNs = expoTimeNs;
  pigeonResult.expoISO = expoISO;
  return pigeonResult;
}
+ (FCPPlatformExposureStateValue *)fromList:(NSArray<id> *)list {
  FCPPlatformExposureStateValue *pigeonResult = [[FCPPlatformExposureStateValue alloc] init];
  pigeonResult.expoTimeNs = [GetNullableObjectAtIndex(list, 0) integerValue];
  pigeonResult.expoISO = [GetNullableObjectAtIndex(list, 1) doubleValue];
  return pigeonResult;
}
+ (nullable FCPPlatformExposureStateValue *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FCPPlatformExposureStateValue fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.expoTimeNs),
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 141: 
      return [FCPPlatformCameraExposureDescription fromList:[self readValue]];
    case 142: 
      return [FCPPlatformExposureStateValue fromList:[self readValue]];
    case 143: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FCPPlatformCameraLensDirectionBox class]]) {
    ...
    [self writeByte:140];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FCPPlatformCameraExposureDescription class]]) {
    [self writeByte:141];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FCPPlatformExposureStateValue class]]) {
    [self writeByte:142];
    [self writeValue:[value toList]];
...
void SetUpFCPCameraApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FCPCameraApi> *api, NSString *messageChannelSuffix) {
  ...
  /// Returns the camera exposure config current description.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.getExposureDescription", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getExposureDescription:)], @"FCPCameraApi api (%@) doesn't respond to @selector(getExposureDescription:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getExposureDescription:^(FCPPlatformCameraExposureDescription *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns -1 if manual exposure control is not supported.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.getMinExposureTime", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMinimumExposureTime:)], @"FCPCameraApi api (%@) doesn't respond to @selector(getMinimumExposureTime:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getMinimumExposureTime:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns -1 if manual exposure control is not supported.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.getMaxExposureTime", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMaximumExposureTime:)], @"FCPCameraApi api (%@) doesn't respond to @selector(getMaximumExposureTime:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getMaximumExposureTime:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns the current exposure time in nanoseconds.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.getCurrentExposureTime", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getCurrentExposureTime:)], @"FCPCameraApi api (%@) doesn't respond to @selector(getCurrentExposureTime:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getCurrentExposureTime:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns -1 if manual ISO control is not supported.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.getMinISO", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMinimumISO:)], @"FCPCameraApi api (%@) doesn't respond to @selector(getMinimumISO:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getMinimumISO:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns -1 if manual ISO control is not supported.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.getMaxISO", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getMaximumISO:)], @"FCPCameraApi api (%@) doesn't respond to @selector(getMaximumISO:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getMaximumISO:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns the current ISO value.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.getCurrentISO", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getCurrentISO:)], @"FCPCameraApi api (%@) doesn't respond to @selector(getCurrentISO:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api getCurrentISO:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  /// Returns the actual exposure time and iso that was set.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.setExposureTime", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setExposureTime:iso:completion:)], @"FCPCameraApi api (%@) doesn't respond to @selector(setExposureTime:iso:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSNumber *arg_exposureTime = GetNullableObjectAtIndex(args, 0);
        NSNumber *arg_iso = GetNullableObjectAtIndex(args, 1);
        [api setExposureTime:arg_exposureTime iso:arg_iso completion:^(FCPPlatformExposureStateValue *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
